...
const Breadcrumbs: React.FC = () => {
  ...
  return (
    <div className="flex items-center px-6 py-3 border-b border-gray-200/50 bg-white/50 backdrop-blur-sm sticky top-0 z-30 shadow-sm shadow-gray-200/20">
              ...
              <li key={name}>
                <div className="flex items-center">
                  ...
                  {isLast ? (
                    ...
                    <Link to={routeTo} className="hover:text-[#f4510b] transition-colors">
                      {formattedName}
                    </Link>
                  )}
                </div>
