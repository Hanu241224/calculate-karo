...
const CategoryCard: React.FC<{ icon: React.ReactNode; count: string; title: string; isActive?: boolean }> = ({ icon, count, title, isActive }) => (
  <div className={`p-5 rounded-3xl border transition-all duration-300 cursor-pointer group ${isActive ? 'bg-gradient-to-br from-[#F8F9FE] to-white border-blue-200 shadow-md shadow-blue-900/5 hover:shadow-lg' : 'bg-white border-gray-100 hover:border-blue-100 hover:shadow-xl hover:shadow-blue-900/5 hover:-translate-y-1'}`}>
